...
void __fastcall TVPrincipal::IniciarTimer(TObject *Sender)
{
    if(VPrincipal->TimerEstadoPuertos->Enabled == false){ //Button timer ON/OFF
        ...
        VPrincipal->CheckBoxDia->Enabled=true;
        VPrincipal->CheckBoxNoche->Enabled=true;
        VPrincipal->CheckBoxPuertaCerrada->Enabled=true;
        VPrincipal->CheckBoxPuertaAbierta->Enabled=true;
    }
}
//---------------------------------------------------------------------------
